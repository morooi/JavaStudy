...
FROM myemployees.myv2
         JOIN job_grades j ON ag BETWEEN lowest_sal AND highest_sal;
...
SELECT department_name, m.ag
FROM myemployees.myv3 m
         JOIN departments d
...
/*
    ...
    查询语句;
*/
    ALTER VIEW myemployees.myv3
    AS SELECT *
       FROM employees;

# 三. 删除视图
# 语法: drop view 视图名,视图名,...;
DROP VIEW myemployees.myv1, myemployees.myv2, myemployees.myv3;
